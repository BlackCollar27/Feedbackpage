        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-16 md:space-y-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="flex-1">
                <div className="inline-block px-4 py-1.5 bg-red-600 text-white text-sm font-semibold rounded-full mb-4">
                  Step 2A: Low Rating (1-3 Stars)
                </div>
                <h3 className="text-2xl md:text-3xl text-slate-900 mb-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              <div className="flex-1 order-2 md:order-1">
                <div className="inline-block px-4 py-1.5 bg-green-600 text-white text-sm font-semibold rounded-full mb-4">
                  Step 2B: High Rating (4-5 Stars)
                </div>
                <h3 className="text-2xl md:text-3xl text-slate-900 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20">
              ...
              <p className="text-slate-200">More positive public reviews</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20">
              <div className="text-4xl font-bold text-white mb-2">↓ 64%</div>
              <p className="text-slate-200">Fewer negative public reviews</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20">
              <div className="text-4xl font-bold text-white mb-2">100%</div>
              <p className="text-slate-200">Visibility into customer concerns</p>
            </div>
          </div>

          <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
            Stop letting unhappy customers damage your online reputation. Start capturing feedback the smart way.
          </p>

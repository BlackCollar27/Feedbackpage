...
export function UserGuideTour({ run = false, onComplete }: UserGuideTourProps) {
  ...
  const steps: Step[] = [
      ...
      content: (
        <div className="p-2">
          ...
          <p className="text-sm text-slate-600">
            This will only take 2 minutes. You can skip anytime by clicking the × button.
          </p>
        </div>
      ),
      placement: 'center',
    ...
    },
    {
      ...
      content: (
        <div className="p-2">
          <h3 className="text-lg font-bold text-slate-900 mb-2">⚙️ Settings & Customization</h3>
          <p className="text-slate-700 mb-2">
            In Settings, you can:
          </p>
...
// Help button component to trigger the tour
